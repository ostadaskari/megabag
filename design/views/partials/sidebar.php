        ...
        <div class="col-1 d-none d-md-flex sidebar flex-column position-relative">
          ...
          <ul class="list-unstyled px-2">
            ...
            <?php if ($role === 'admin' || $role === 'manager'): ?>
             ...
             <li class="menu-item">
              ...
              <li class="menu-item has-submenu">
                <a  class="menu-link">
                <svg width="22" height="22" fill="" class="bi bi-bezier" viewBox="0 0 16 16">
            ...
            <!-- Add feature to category -->
              ...
              <li class="menu-item has-submenu">
                <a  class="menu-link">
                  <svg width="24" height="24" fill="" class="bi bi-box-arrow-in-left" viewBox="0 0 16 16">
            ...
            <li class="menu-item has-submenu">
              <a  class="menu-link">
                <svg width="24" height="24" fill="" class="bi bi-box-arrow-right" viewBox="0 0 16 16">
            ...
            <li class="menu-item has-submenu">
              <a  class="menu-link">
                <svg width="24" height="24" fill="" class="bi bi-flag" viewBox="0 0 16 16">
            ...
            <li class="menu-item has-submenu">
              <a  class="menu-link">
                <svg width="24" height="24" fill="" class="bi bi-person-add" viewBox="0 0 16 16">
            ...
            <li class="menu-item">
              <a href="?page=filter_search" class="menu-link">
                <svg width="24" height="24" fill="" class="bi bi-search" viewBox="0 0 16 16">
            ...
            <!-- profile -->
             <li class="menu-item" data-content="profile">
              <a href="?page=profile" class="menu-link">
                <svg width="22" height="22" fill="" class="bi bi-person-square" viewBox="0 0 16 16">
