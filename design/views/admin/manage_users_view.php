    ...
    <div class="row">
      <div class="col-12 col-md-6" style="margin: auto;">
            <div class="input-box my-0" style="width:100%;">
                ...
                <input type="text" id="searchInput" class="form-control mb-2" placeholder="Search by name, family, or nickname">
            </div>
        </div>
    </div>  
        ...
        fetch(`../admin/manage_users.php?ajax=1&page=${page}&search=${encodeURIComponent(search)}`)
            ...
            .then(data => {
                ...
                if (data.success) {
                    ...
                    // Check if there is more than one page before generating pagination
                    let paginationHtml = '';
