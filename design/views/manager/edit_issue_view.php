<div class="d-flex flex-row align-items-center justify-content-between titleTop">
    <h2 class="d-flex align-items-center">
        <svg width="24" height="24" fill="currentColor" class="bi bi-pencil-square mx-1 me-2" viewBox="0 0 16 16">
            <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.5a.5.5 0 0 0-.175.761L12.793 5.72 1.34 14.591a.5.5 0 0 0 .147.118l3.659 1.144a.5.5 0 0 0 .614-.147l1.314-1.314L11.5 12a.5.5 0 0 0 .5-.5V8.5a.5.5 0 0 0-.5-.5zM12.5 13a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2z"/>
        </svg>
        Edit Issue</h2>
