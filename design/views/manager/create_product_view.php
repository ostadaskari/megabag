    ...
    <form method="post" enctype="multipart/form-data" class="d-flex flex-column partForm">
        ...
        <div class="container bg-light border rounded shadow-sm p-2 mb-2">
            ...
            <div class="row d-flex justify-content-between">
                ...
                <div class="col-12 col-md-2 px-2 my-2 form-check d-flex align-items-center justify-content-center">
                    <input class="form-check-input" type="checkbox" value="1" id="rfCheckbox" name="rf">
                    <label class="form-check-label mx-2" for="rfCheckbox">
                        RF
                    </label>
                </div>
            </div>
