          ...
          <div id="Add-Single-part" class="tab-content mb-2">
            <form  method="post" enctype="multipart/form-data" class="d-flex flex-column partForm">
               <!-- part number and Manufacturer inputs -->
                ...
                <div class="container bg-light border rounded shadow-sm p-3 mb-2">
                ...
                <div class="row mt-1 mb-3 d-flex justify-content-between">
                    <div class="col-12 col-md-6 d-flex justify-content-center">
                        <div class="border rounded shadow-sm p-3" style="width: 96%;">
                            <div class="form-label d-flex align-items-center">
                                <svg width="18" height="18" fill="currentColor" class="bi bi-card-image" viewBox="0 0 16 16">
                    ...
                    <div class="col-12 col-md-6 d-flex justify-content-center">
                        <div class="border rounded shadow-sm p-3" style="width: 96%;">
                            <div class="form-label d-flex align-items-center">
                                <svg width="18" height="18" fill="currentColor" class="bi bi-file-earmark-image" viewBox="0 0 16 16">
